const Header = ()=>{
  return(
    <div className="w-full h-[110px] flex items-center border">
      ...
      <div className="pr-[54px] flex justify-end w-full items-center">
        <button className="px-[22px] py-[12px] mr-[22px] border-2 border-[#764CC2] text-[#764CC2] font-bold rounded-full">Share new video</button>
