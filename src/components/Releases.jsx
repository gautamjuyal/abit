    ...
    <div className="pt-[123px] px-[96px]">
      <div className="flex justify-between">
        <div>
          ...
          <div className="mt-[14px]">Videos that you upload in collaboration with aBit appear here.</div>
        </div>
        <div className="flex">
      ...
      <div className="my-[68px] flex gap-[42px]">
        <div className="bg-[#EDEDED] w-[283px] h-[312px] p-8 rounded-[24px] items-center  justify-end text-center text-[#A0A0A0] flex flex-col">
          ...
          <div className="mt-[62px] font-[400]">You haven’t uploaded any videos with aBit yet. Add now!</div>
        </div>
